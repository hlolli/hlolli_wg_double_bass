...
<CsInstruments>
; Native/browser regression: midpoint onset, first three bars of BWV 1007.
...
instr Note
  ...
  ; Listening candidate only: retain the original body/sympathy balance.
  kForce linseg p7 + 0.135 * p9, 0.03, p7
  kTime timeinsts
  kGate = kTime < p3 * p8 ? 1 : 0
  aLeft, aRight hlolli_wg_double_bass \
      kGate, cpsmidinn(p4), kForce, 0.45 * p6, 0.12, \
      0, 0, 0, 0, 0, p5, giBass
...
i "Note"       2       1  47   4  -1 0.48 0.94 1
i "Note"       3     0.5  45   4   1 0.48 1 1
i "Note"     3.5    0.25  47   4   1 0.48 1 0
i "Note"    3.75    0.25  48   4   1 0.48 0.94 0
; Source bar 2
i "Note"       4     0.5  47   4  -1 0.52 1 1
i "Note"     4.5     0.5  45   4  -1 0.48 0.94 0
i "Note"       5     0.5  43   3   1 0.48 1 1
i "Note"     5.5     0.5  42   3   1 0.48 0.94 0
i "Note"       6     0.5  43   3  -1 0.48 1 1
i "Note"     6.5     0.5  38   3  -1 0.48 0.94 0
; Source bar 3
; Keep C3-A2 on the D string: the commanded stop replaces the prior G2 tail.
i "Note"       7     0.5  40   3   1 0.52 1 1
i "Note"     7.5     0.5  43   3   1 0.48 0.94 0
i "Note"       8     0.5  48   3  -1 0.48 1 1
i "Note"     8.5     0.5  45   3  -1 0.48 0.94 0
i "Note"       9     0.5  42   3   1 0.48 1 1
i "Note"     9.5     0.5  50   3   1 0.48 0.94 0
e
</CsScore>
</CsoundSynthesizer>
